...
func TestAuthScriptMatchesItsPages(t *testing.T) {
	...
	pageNames := []string{"web/login.html", "web/pending.html", "web/enroll.html", "web/delegation.html", "web/delegation-error.html", "web/webfetch-connect.html", "web/oauth.html"}
