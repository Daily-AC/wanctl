...
var pages = template.Must(template.ParseFS(assets, "web/login.html", "web/pending.html", "web/enroll.html", "web/delegation.html", "web/delegation-error.html", "web/webfetch-connect.html", "web/webfetch-help.html"))
