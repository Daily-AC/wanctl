...
| `WANCTL_WEBFETCH_SEED` | relay 内的控制端适配器 | 否 | 关闭 | 至少 32 字节的十六进制秘密种子，启用 `/webfetch`；必须连接 PostgreSQL。见 [WebFetch](https://github.com/Daily-AC/wanctl/blob/main/docs/webfetch.md)。 |
